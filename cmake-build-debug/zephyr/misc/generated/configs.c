...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32F3_FLASH_CONTROLLER_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_F303RE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_STM32F303XE, 1);
